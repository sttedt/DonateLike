			...
			<div class="container" style="height: 110px">
				<div style="text-align : right; font-size: 10pt; height : 22px; margin-top: 7px" >
					...
					<nav class="navbar navbar-expand-lg navbar-light" style="padding-top: 10px">
					  <i class="fas fa-puzzle-piece" style="font-size: 60px; color:#298A08;">&nbsp;<a class="navbar-brand" href="#" style="opacity: 0.8; font-size:27pt;">기부니좋아</a></i>
					  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
					    <span class="navbar-toggler-icon"></span>
					  </button>
					  <div class="collapse navbar-collapse" id="navbarNav" style="padding-top: 12px;">
